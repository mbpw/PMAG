...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser() {
        ...
        if (email.isEmpty()) {
            editTextEmail.setError(getResources().getString(R.string.error_field_required));
        ...
        if (password.isEmpty()) {
            editTextPassword.setError(getResources().getString(R.string.error_field_required));
